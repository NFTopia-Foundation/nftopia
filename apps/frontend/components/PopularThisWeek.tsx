...
export default function NFTCard({ id, image, name, price, desc }: NFTItem) {
  return (
    <div className="relative w-full max-w-[300px] h-auto min-h-[200px] rounded-xl overflow-hidden group">
      ...
      <div className="relative flex flex-col h-full bg-gradient-to-b from-[#0d0f1a] via-[#1a1d33] to-[#0d0f1a] backdrop-blur-sm rounded-xl z-10 border border-[#ffffff10]">
        ...
        <div className="flex-1 p-5 flex flex-col">
          ...
          <div className="mt-auto flex items-center justify-between">
            <span className="bg-[#000a2e] text-[#00c6fb] rounded-full border border-[#00c6fb50] px-4 py-2 text-sm font-mono min-h-[48px] min-w-[48px] text-[clamp(0.9rem,2vw,1.05rem)]">
              {price}
            </span>
