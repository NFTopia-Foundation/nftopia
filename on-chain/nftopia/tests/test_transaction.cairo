...
fn test_multiple_transactions() {
    ...
    assert(dispatcher.has_user_purchased(user, *token_ids.at(0)), 'Should have purchased token 1');
    assert(dispatcher.has_user_purchased(user, *token_ids.at(1)), 'Should have purchased token 2');
    assert(dispatcher.has_user_purchased(user, *token_ids.at(2)), 'Should have purchased token 3');
}
